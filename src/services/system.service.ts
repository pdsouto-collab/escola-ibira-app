...
export async function executeDatabaseCommand(commandType: 'migrate-dev' | 'migrate-deploy', options?: { migrationName?: string }): Promise<{ success: boolean, output: string }> {
