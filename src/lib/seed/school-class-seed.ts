...
export const schoolClassesDataSeed: SchoolClass[] = [
    ...
    { id: "jardim-i", name: "Jardim I", description: "4 a 5 anos", teacherId: "cmmxtwf180001dqncotwroirc" }, // Assigned to Cláudia
    { id: "jardim-ii", name: "Jardim II", description: "5 a 6 anos", teacherId: "cmmxtwf180001dqncotwroirc" }, // Assigned to Cláudia
];
