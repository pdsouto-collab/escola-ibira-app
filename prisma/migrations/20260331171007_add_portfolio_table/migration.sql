/*
  ...
  - You are about to drop the column `teste` on the `PegadaInteraction` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "PegadaInteraction" DROP COLUMN "teste";
